...
The `ggplot()` function is used to initialize the basic graph structure, then we add additional layers to it. The basic idea is that you specify different parts of the plot, and add them together using the `+` operator.
